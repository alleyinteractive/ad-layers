<?php
/**
 * Ad Layers Tests: Ad_Layers_UnitTestCase
 *
 * @package Ad_Layers
 * @subpackage Tests
 */
...
/**
 * Ad_Layers_TestCase Class.
 */
class Ad_Layers_TestCase extends WP_UnitTestCase {
	protected $ad_server_parent, $ad_server, $ad_layer, $ad_server_settings;

	public function setUp() {
		parent::setUp();

		$this->ad_server_parent = Ad_Server::instance();
