	...
	class Ad_Layers_Widget extends WP_Widget {
		...
		public function form( $instance ) {
			...
			<p>
				...
				<br />
				<?php echo $this->ad_unit_select_field_html( $ad_unit ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
		 ...
		 * @param array $old_instance current instance of the widget.
